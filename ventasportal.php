...
<input type="text" id="busquedaCodigo" placeholder="Código" <?php if($tipo==24){ echo "readonly"; } ?>/>
<input type="text" id="busquedaDescripcion" placeholder="Descripción" size="70" <?php if($tipo==24){ echo "readonly"; } ?>/>
