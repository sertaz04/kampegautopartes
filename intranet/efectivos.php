<html>
    ...
    <body>
       ...
       <div class="container">
          <h2>Lista de efectivos</h2>
			<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Buscar Efectivo..." autocomplete="off" />
			<a rel="facebox" href="purchases.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Agregar efectivos</button></a>
<br><br>
          <table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
            <thead>
                <tr>
                    <th width="15%"> Número Efectivo </th>
                    <th width="15%"> Fecha Efectivo</th>
            ...
            <tbody>
                    ...
                    <?php
                        include('../connect.php');
                        $result = mysql_query("SELECT p.*, s.suplier_name FROM efectivos p left join supliers s on p.suplier_id = s.suplier_id WHERE empresa_id = $sesionEmpresaID AND p.`delete`='0' ORDER BY p.transaction_id DESC");
