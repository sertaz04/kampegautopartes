<html>
 ...
 <div class="container">
			<ul class="breadcrumb">
				<li><a href="index.php">
				Tablero</a></li>
				<li class="active">Reporte Cartola de Clientes</li>
			</ul>
<div id="maintable">
<a  href="index.php"><button class="btn btn-default btn-large" style="float: none;"><i class="icon icon-circle-arrow-left icon-large"></i> Volver</button></a><br><br>
	...
	<form id="resumenOrden" action="reporteClienteCartolaExcel.php" method="post">
		...
		<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
			...
			<tbody>
				...
				<tr>
					<td>Clientes:</td>
					<td>
						<select name="idCliente" id="idCliente" class="grande" style="width: 450px;" required>
						<option></option>
							<?php
							include('../connect.php');
