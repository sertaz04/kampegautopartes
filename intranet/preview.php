...
$result = mysql_query("SELECT * FROM sales WHERE invoice_number= '$invoice' AND empresa_id = $sesionEmpresaID AND delete='0'");
...
<?php include('navfixed.php');?>
	...
	<div class="span2">
			...
			<li><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Inventario producto</a>                </li>
				<br><br><br><br><br><br>		
			<li>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	Kampeg Chile S.A.	<br>
	Av. Caupolican 101, Local 2	<br>	<br>
	</center>
	<div>
	<?php
	$resulta = mysql_query("SELECT * FROM customer WHERE customer_name= '$cname' AND empresa_id = $sesionEmpresaID");
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		<thead>
			<tr>
				<th width="90">C&oacute;digo de producto</th>
		...
		<tbody>
				...
				<?php
					...
					$result = mysql_query("SELECT * FROM sales_order WHERE invoice= '$id' AND empresa_id = $sesionEmpresaID");
					while($row = mysql_fetch_array($result, MYSQL_ASSOC))
				...
				<tr>
					...
					$resultas = mysql_query("SELECT sum(amount) FROM sales_order WHERE invoice= '$sdsd' AND empresa_id = $sesionEmpresaID");
