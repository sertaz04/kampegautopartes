...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="13%"> ID Transacci&oacute;n </th>
			<th width="13%"> Fecha Transacci&oacute;n </th>
			<th width="20%"> Nombre Cliente </th>
			<th width="16%"> N&uacute;mero de Boleta </th>
	...
	<tbody>
			...
			<?php
				...
				$result = mysql_query("SELECT * FROM sales WHERE date BETWEEN '$d1' AND '$d2' AND delete='0' ORDER by transaction_id DESC");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$results = mysql_query("SELECT sum(amount) FROM sales WHERE date BETWEEN '$d1' AND '$d2' AND delete='0'");
				...
				<th colspan="1" style="border-top:1px solid #999999">
			<?php 
				$resultia = mysql_query("SELECT sum(profit) FROM sales WHERE date BETWEEN '$d1' AND '$d2' AND delete='0'");
				while($cxz = mysql_fetch_array($resultia, MYSQL_ASSOC))
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Est&aacute; seguro que desea borrar? Este proceso no es reversible!"))
		  {
