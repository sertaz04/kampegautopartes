...
<center>
<input type="text" size="25" value="" name="cname" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="Introduzca Nombre Cliente" style="width: 268px; height:30px;" />
