...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: none;"><i class="icon icon-circle-arrow-left icon-large"></i> Volver</button></a><br><br>
	...
	<form id="resumenOrden" action="reporteVentasExcel.php" method="post">
				...
				<tr>
					...
					<td>
						...
						<option></option>
							<?php
							include('../connect.php');
							$result = mysql_query("SELECT * FROM customer WHERE empresa_id = $sesionEmpresaID and `delete`='0' order by rut");
