...
<input type="hidden" id="saldoMaximo" name="saldoMaximo" value="<? echo $saldoMaximo;?>" />
	...
	$result = mysql_query("
		...
		$rowSIIBoton = mysql_num_rows($result); //mysql_fetch_array($result, MYSQL_ASSOC);
		...
		$idRef = $id;
            ...
            <?php if($saldoMaximo>0){?>
	            <div class="alert alert-success">
				  <strong>CLIENTE CON CUENTA CORRIENTE!</strong> Este cliente permite pago con crédito como máximo de: <?php echo $saldoMaximo?>.
				</div>
            <?php }?>
            <?php } //tipo documento?>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><center>
			<a href="<?php if($tipo==24 || ($tipo==26 && $idReferencia!='')){ echo "#"; }else{ ?>deletepventa.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['iv']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['name'];?>&sp=<?php echo $customer; }?>">
			    <button class="btn btn-danger btn-mini <?php if($tipo==24 || ($tipo==26 && $idReferencia!='')){ echo "disabled"; } ?>"><i class="icon-trash"></i> Borrar </button>
			</a></td>
			</center>
			</tr>
			<?php
...
<? 	}else{
	...
	?>
<?php	
if ($rowSIIBoton<=0 or $rowSIIBoton==''){ ?>
