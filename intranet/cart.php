		...
		<label>alphaware</label>
			...
			<?php
				$id = (int) $_SESSION['id'];
					...
					$query = mysql_query ("SELECT * FROM customer WHERE customerid = '$id' AND empresa_id = $sesionEmpresaID") or die (mysql_error());
...
if (isset($_SESSION['cart']))
	...
	{
	$result=mysql_query("Select * from product where product_id=$id AND empresa_id = $sesionEmpresaID");
