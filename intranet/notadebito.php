<html>
    <head>
        ...
        <script>
			...
			$(function() {
				...
				var info = 'id=' + del_id;
				 if(confirm("Está seguro que desea borrar a esta Nota Débito? \n Este proceso no es reversible!"))
				{
				 $.ajax({
				   type: "GET",
				   url: "deletenotadebito.php",
				   data: info,
				   success: function(){
						alert('La Nota Débito se ha borrado correctamente.');
				   },
				 });
			...
			$(document).ready(function(){
				$("#myBtn").click(function(){
					...
					$("#userForm").attr("action", "savenotadebito.php");
					$("#myModal").modal();
				});
			});
				...
				$(".editButton").click(function(){
					...
					$.ajax({
						...
						method: 'GET'
							...
							$("#userForm").attr("action", "saveeditnotadebito.php");
							$("#myModal").modal();
    ...
    <body>
       ...
       <div class="container">
          <h2>Lista de Notas de D&eacute;bito</h2>
...
<br><br>
          <table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
            <thead>
                <tr>
                    <th width="15%"> Número Nota de D&eacute;bito </th>
                    <th width="15%"> Fecha Nota de D&eacute;bito</th>
