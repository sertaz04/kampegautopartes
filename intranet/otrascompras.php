<html>
    <head>
        ...
        <script>
			...
			$(function() {
				...
				var info = 'id=' + del_id;
				 if(confirm("Está seguro que desea borrar a esta compra? \n Este proceso no es reversible!"))
				{
				 $.ajax({
				   type: "GET",
				   url: "deleteotrascompras.php",
				   data: info,
				   success: function(){
						alert('La compra se ha borrado correctamente.');
				   },
				 });
			...
			$(document).ready(function(){
				$("#myBtn").click(function(){
					...
					$("#userForm").attr("action", "saveotrascompras.php");
					$("#myModal").modal();
				});
			});
				...
				$(".editButton").click(function(){
					...
					$.ajax({
						...
						method: 'GET'
							...
							$("#userForm").attr("action", "saveeditotrascompras.php");
							$("#myModal").modal();
    ...
    <body>
       ...
       <div class="container">
          <h2>Lista de Otras Compras</h2>
			<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Buscar Cliente..." autocomplete="off" />
            
            <Button type="button" class="btn btn-info btn-lg" id="myBtn" style="float:right; width:230px; height:35px;" />Agregar Compra</button>
<br><br>
